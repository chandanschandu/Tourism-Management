        ...
        <div class="col-md-6">
            ...
            <input type="hidden" name="id" value="<?php echo $_settings->userdata('id') ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="mnumber" minlength="10" maxlength="10" class="form-control form" value="<?php echo $_settings->userdata('mnumber') ?>" placeholder="(Enter mobile number )">
                </div>
                <!-- <div class="form-group"> -->
                    <!-- <p style="color:red;">you have to make payment through this id </P> -->
                    <!-- <label for="upi-id" class="control-label">UPI-ID</label> -->
                    <!-- <input type="text" name="upiid" class="form-control form" value="<?php echo $_settings->userdata('upiid') ?>" placeholder="(Enter UPI-ID )"> -->
                <!-- </div> -->
