...
INSERT INTO `book_list` (`id`, `name`, `adar`, `email`, `user_id`, `package_id`, `status`, `schedule`, `howmany`, `date_created`) VALUES
(2, 'adithya', '123456789098', 'adi@gmail.com', 4, 8, 3, '2021-06-21', '4', '2021-06-19 08:37:59'),
(3, 'adi', '123213456546', 'adi2@gmail.com', 5, 8, 3, '2021-06-18', '50', '2021-06-19 11:51:50');



CREATE TABLE `vehiclebook_list` (
  `id` int(30) NOT NULL,
  ...
  `status` tinyint(4) NOT NULL DEFAULT 0 COMMENT '0=pending,1=confirm, 2=cancelled\r\n',
  `schedule1` date NOT NULL,
  `schedule2` date NOT NULL,
  `schedule3` int(3) NOT NULL,
  `howmany` int(12) NOT NULL,
  `date_created` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `vehiclebook_list` (`id`, `name`, `adar`, `email`, `user_id`, `vehicle_id`, `status`, `schedule1`, `schedule2`, `schedule3`,`howmany`, `date_created`) VALUES
(2, 'adi', '213456654321', 'adi@gmail.com', 4, 8, 3, '2021-06-21', '2011-06-31', '5', '4', '2021-06-19 08:37:59'),
(3, 'adthi', '213456654321', 'adiw@gmail.com', 5, 8, 3, '2021-06-18', '2011-06-31', '2', '50', '2021-06-19 11:51:50');

CREATE TABLE `hotelbook_list` ( 
  `id` int(30) NOT NULL,
  `name` int(20) NOT NULL,
  `adar` int(12) NOT NULL,
  `email` text NOT NULL,
  ...
  `schedule2` date NOT NULL,
  `schedule3` int(3) NOT NULL,
  `howmany1` int(12) NOT NULL,
  `howmany2` int(12) NOT NULL,
  `date_created` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `hotelbook_list` (`id`, `name`, `adar`, `email`, `user_id`, `hotel_id`, `status`, `schedule1`, `schedule2`, `schedule3`,`howmany1`, `howmany2`, `date_created`) VALUES
(2, 'adi', '213456654321', 'adi@gmail.com', 4, 8, 3, '2021-06-21', '2011-06-31', '5', '4', '4', '2021-06-19 08:37:59'),
(3, 'adthi', '213456654321', 'adiw@gmail.com', 5, 8, 3, '2021-06-18', '2011-06-31', '2', '50', '5', '2021-06-19 11:51:50');
...
(6, 'asdasd', 'asdasd@asdasd.com', 'assd', 'asgdhgfddgvs', 1, '2021-06-19 10:19:27');
...
INSERT INTO `hotels` (`id`, `title`, `hotel_location`, `cost`, `description`, `adress`, `upload_path`, `status`, `date_created`) VALUES
(1, 'Sample Tour 101', 'Sample Location1, Sample Location2, and Sample Location3', 2500, '&lt;p style=&quot;margin-right: 0px; margin-bottom: 15px; margin-left: 0px; padding: 0px; text-align: justify; color: rgb(0, 0, 0); font-family: &amp;quot;Open Sans&amp;quot;, Arial, sans-serif;&quot;&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam vel molestie ante. Morbi volutpat vestibulum nibh, vitae tempor metus sodales ac. Praesent et ornare lorem. Nullam id sem sed dolor feugiat finibus eu imperdiet erat. Suspendisse sed est eu enim lacinia efficitur eu eget sem. Curabitur feugiat, ipsum vel eleifend tincidunt, lacus metus tristique sem, non vehicula purus ipsum eget magna. Phasellus feugiat molestie nibh, sit amet elementum nulla volutpat sit amet. Integer a consequat metus, eget consectetur urna. Phasellus sagittis tincidunt egestas.&lt;/p&gt;&lt;p style=&quot;margin-right: 0px; margin-bottom: 15px; margin-left: 0px; padding: 0px; text-align: justify; color: rgb(0, 0, 0); font-family: &amp;quot;Open Sans&amp;quot;, Arial, sans-serif;&quot;&gt;Curabitur non elit blandit, vestibulum sem in, maximus lectus. Nam laoreet nulla nec est pulvinar sagittis. Maecenas sit amet vestibulum ligula. Donec sit amet scelerisque risus, id aliquet lectus. Cras id sagittis lorem. Vestibulum aliquam feugiat semper. Nulla egestas est vitae est fringilla, non pretium urna malesuada. Nulla ultricies ipsum vel metus volutpat dictum a a mauris. Ut eu justo id ante efficitur semper. Suspendisse potenti. In luctus, libero non dignissim sollicitudin, quam magna rhoncus urna, eu tempor dolor dolor sit amet lacus. Mauris sed libero ut nisl ornare congue facilisis vitae velit. Praesent suscipit sem bibendum fermentum cursus. Morbi in justo imperdiet, tristique ante at, sagittis ante. Ut nec mauris vitae nisl sodales facilisis. Etiam pharetra nisi congue, interdum neque vel, porta magna.&lt;/p&gt;&lt;p style=&quot;margin-right: 0px; margin-bottom: 15px; margin-left: 0px; padding: 0px; text-align: justify; color: rgb(0, 0, 0); font-family: &amp;quot;Open Sans&amp;quot;, Arial, sans-serif;&quot;&gt;Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Ut ac magna sodales, bibendum ante ut, accumsan ante. Integer non consectetur augue. Donec eget neque varius, venenatis elit id, dapibus tellus. Nam libero nulla, blandit sit amet ligula eu, malesuada lobortis diam. Maecenas ut tellus eget leo tincidunt pulvinar. Aenean rutrum, risus a aliquam euismod, nunc nisl tempus tortor, vel pellentesque eros ex nec purus. In condimentum nulla non ipsum interdum efficitur. Mauris eget sapien nec justo dignissim pretium quis sit amet ex. Aenean fermentum, metus eget dignissim condimentum, dui metus placerat diam, vitae interdum eros ante eget nisl. Fusce at orci gravida, varius mi ac, fermentum justo.&lt;/p&gt;', 'ggyygy/hg/g', 'uploads/hotel_1', 1, '2021-06-18 10:31:03'),
(7, 'Sample 102', 'Sample Location', 500, '&lt;p&gt;&lt;span style=&quot;color: rgb(0, 0, 0); font-family: &amp;quot;Open Sans&amp;quot;, Arial, sans-serif; text-align: justify;&quot;&gt;Curabitur non elit blandit, vestibulum sem in, maximus lectus. Nam laoreet nulla nec est pulvinar sagittis. Maecenas sit amet vestibulum ligula. Donec sit amet scelerisque risus, id aliquet lectus. Cras id sagittis lorem. Vestibulum aliquam feugiat semper. Nulla egestas est vitae est fringilla, non pretium urna malesuada. Nulla ultricies ipsum vel metus volutpat dictum a a mauris. Ut eu justo id ante efficitur semper. Suspendisse potenti. In luctus, libero non dignissim sollicitudin, quam magna rhoncus urna, eu tempor dolor dolor sit amet lacus. Mauris sed libero ut nisl ornare congue facilisis vitae velit. Praesent suscipit sem bibendum fermentum cursus. Morbi in justo imperdiet, tristique ante at, sagittis ante. Ut nec mauris vitae nisl sodales facilisis. Etiam pharetra nisi congue, interdum neque vel, porta magna.&lt;/span&gt;&lt;br&gt;&lt;/p&gt;', 'asdas', 'uploads/hotel_7', 1, '2021-06-18 11:17:11'),
(8, 'Sample 103', 'Sample Location', 3000, '&lt;p&gt;&lt;span style=&quot;color: rgb(0, 0, 0); font-family: &amp;quot;Open Sans&amp;quot;, Arial, sans-serif; text-align: justify;&quot;&gt;Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Ut ac magna sodales, bibendum ante ut, accumsan ante. Integer non consectetur augue. Donec eget neque varius, venenatis elit id, dapibus tellus. Nam libero nulla, blandit sit amet ligula eu, malesuada lobortis diam. Maecenas ut tellus eget leo tincidunt pulvinar. Aenean rutrum, risus a aliquam euismod, nunc nisl tempus tortor, vel pellentesque eros ex nec purus. In condimentum nulla non ipsum interdum efficitur. Mauris eget sapien nec justo dignissim pretium quis sit amet ex. Aenean fermentum, metus eget dignissim condimentum, dui metus placerat diam, vitae interdum eros ante eget nisl. Fusce at orci gravida, varius mi ac, fermentum justo.&lt;/span&gt;&lt;br&gt;&lt;/p&gt;', 'hshsgd/sd;sd;d', 'uploads/hotel_8', 1, '2021-06-18 13:34:08');
...
CREATE TABLE `vehicles` (
  `id` int(30) NOT NULL,
  `title` text DEFAULT NULL,
  `vehicle_location` text DEFAULT NULL,
  `cost` double NOT NULL,
  `description` text DEFAULT NULL,
  `adress` text DEFAULT NULL,
  `upload_path` text DEFAULT NULL,
...
INSERT INTO `vehicles` (`id`, `title`, `vehicle_location`, `cost`, `description`, `adress`, `upload_path`, `status`, `date_created`) VALUES
(1, 'Sample Tour 101', 'Sample Location1, Sample Location2, and Sample Location3', 2500, '&lt;p style=&quot;margin-right: 0px; margin-bottom: 15px; margin-left: 0px; padding: 0px; text-align: justify; color: rgb(0, 0, 0); font-family: &amp;quot;Open Sans&amp;quot;, Arial, sans-serif;&quot;&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam vel molestie ante. Morbi volutpat vestibulum nibh, vitae tempor metus sodales ac. Praesent et ornare lorem. Nullam id sem sed dolor feugiat finibus eu imperdiet erat. Suspendisse sed est eu enim lacinia efficitur eu eget sem. Curabitur feugiat, ipsum vel eleifend tincidunt, lacus metus tristique sem, non vehicula purus ipsum eget magna. Phasellus feugiat molestie nibh, sit amet elementum nulla volutpat sit amet. Integer a consequat metus, eget consectetur urna. Phasellus sagittis tincidunt egestas.&lt;/p&gt;&lt;p style=&quot;margin-right: 0px; margin-bottom: 15px; margin-left: 0px; padding: 0px; text-align: justify; color: rgb(0, 0, 0); font-family: &amp;quot;Open Sans&amp;quot;, Arial, sans-serif;&quot;&gt;Curabitur non elit blandit, vestibulum sem in, maximus lectus. Nam laoreet nulla nec est pulvinar sagittis. Maecenas sit amet vestibulum ligula. Donec sit amet scelerisque risus, id aliquet lectus. Cras id sagittis lorem. Vestibulum aliquam feugiat semper. Nulla egestas est vitae est fringilla, non pretium urna malesuada. Nulla ultricies ipsum vel metus volutpat dictum a a mauris. Ut eu justo id ante efficitur semper. Suspendisse potenti. In luctus, libero non dignissim sollicitudin, quam magna rhoncus urna, eu tempor dolor dolor sit amet lacus. Mauris sed libero ut nisl ornare congue facilisis vitae velit. Praesent suscipit sem bibendum fermentum cursus. Morbi in justo imperdiet, tristique ante at, sagittis ante. Ut nec mauris vitae nisl sodales facilisis. Etiam pharetra nisi congue, interdum neque vel, porta magna.&lt;/p&gt;&lt;p style=&quot;margin-right: 0px; margin-bottom: 15px; margin-left: 0px; padding: 0px; text-align: justify; color: rgb(0, 0, 0); font-family: &amp;quot;Open Sans&amp;quot;, Arial, sans-serif;&quot;&gt;Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Ut ac magna sodales, bibendum ante ut, accumsan ante. Integer non consectetur augue. Donec eget neque varius, venenatis elit id, dapibus tellus. Nam libero nulla, blandit sit amet ligula eu, malesuada lobortis diam. Maecenas ut tellus eget leo tincidunt pulvinar. Aenean rutrum, risus a aliquam euismod, nunc nisl tempus tortor, vel pellentesque eros ex nec purus. In condimentum nulla non ipsum interdum efficitur. Mauris eget sapien nec justo dignissim pretium quis sit amet ex. Aenean fermentum, metus eget dignissim condimentum, dui metus placerat diam, vitae interdum eros ante eget nisl. Fusce at orci gravida, varius mi ac, fermentum justo.&lt;/p&gt;', 'ggyygy/hg/g', 'uploads/vehicle_1', 1, '2021-06-18 10:31:03'),
(7, 'Sample 102', 'Sample Location', 500, '&lt;p&gt;&lt;span style=&quot;color: rgb(0, 0, 0); font-family: &amp;quot;Open Sans&amp;quot;, Arial, sans-serif; text-align: justify;&quot;&gt;Curabitur non elit blandit, vestibulum sem in, maximus lectus. Nam laoreet nulla nec est pulvinar sagittis. Maecenas sit amet vestibulum ligula. Donec sit amet scelerisque risus, id aliquet lectus. Cras id sagittis lorem. Vestibulum aliquam feugiat semper. Nulla egestas est vitae est fringilla, non pretium urna malesuada. Nulla ultricies ipsum vel metus volutpat dictum a a mauris. Ut eu justo id ante efficitur semper. Suspendisse potenti. In luctus, libero non dignissim sollicitudin, quam magna rhoncus urna, eu tempor dolor dolor sit amet lacus. Mauris sed libero ut nisl ornare congue facilisis vitae velit. Praesent suscipit sem bibendum fermentum cursus. Morbi in justo imperdiet, tristique ante at, sagittis ante. Ut nec mauris vitae nisl sodales facilisis. Etiam pharetra nisi congue, interdum neque vel, porta magna.&lt;/span&gt;&lt;br&gt;&lt;/p&gt;', 'asdas', 'uploads/vehicle_7', 1, '2021-06-18 11:17:11'),
(8, 'Sample 103', 'Sample Location', 3000, '&lt;p&gt;&lt;span style=&quot;color: rgb(0, 0, 0); font-family: &amp;quot;Open Sans&amp;quot;, Arial, sans-serif; text-align: justify;&quot;&gt;Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Ut ac magna sodales, bibendum ante ut, accumsan ante. Integer non consectetur augue. Donec eget neque varius, venenatis elit id, dapibus tellus. Nam libero nulla, blandit sit amet ligula eu, malesuada lobortis diam. Maecenas ut tellus eget leo tincidunt pulvinar. Aenean rutrum, risus a aliquam euismod, nunc nisl tempus tortor, vel pellentesque eros ex nec purus. In condimentum nulla non ipsum interdum efficitur. Mauris eget sapien nec justo dignissim pretium quis sit amet ex. Aenean fermentum, metus eget dignissim condimentum, dui metus placerat diam, vitae interdum eros ante eget nisl. Fusce at orci gravida, varius mi ac, fermentum justo.&lt;/span&gt;&lt;br&gt;&lt;/p&gt;', 'hshsgd/sd;sd;d', 'uploads/vehicle_8', 1, '2021-06-18 13:34:08');
...
(3, 5, 8, 5, 'Sample', '2021-06-19 11:53:16'),
(4, 5, 8, 4, '&lt;p&gt;Sample feedback only&lt;/p&gt;', '2021-06-19 13:49:26');

-- --------------------------------------------------------
CREATE TABLE `rate_review1` (
  `id` int(30) NOT NULL,
  `user_id` int(30) NOT NULL,
...
INSERT INTO `rate_review1` (`id`, `user_id`, `hotel_id`, `rate`, `review`, `date_created`) VALUES
(1, 3, 2, 5, '<p>Sample</p>', '2021-06-19 11:53:16'),
(4, 4, 5, 4, '&lt;p&gt;Sample feedback only&lt;/p&gt;', '2021-06-19 13:49:26');


--

CREATE TABLE `rate_review2` (
  `id` int(30) NOT NULL,
  `user_id` int(30) NOT NULL,
...
INSERT INTO `rate_review2` (`id`, `user_id`, `vehicle_id`, `rate`, `review`, `date_created`) VALUES
(1, 3, 2, 5, '<p>Sample</p>', '2021-06-19 11:53:16'),
(4, 4, 5, 4, '&lt;p&gt;Sample feedback only&lt;/p&gt;', '2021-06-19 13:49:26');
...
INSERT INTO `users` (`id`, `mnumber`, `upiid`, `firstname`, `lastname`, `username`, `password`, `email`, `avatar`, `last_login`, `type`, `date_added`, `date_updated`) VALUES
(1, 5463212345, 'adithya@ybl', 'Adminstrator', 'Admin', 'admin', '0192023a7bbd73250516f069df18b500', 'admin@admin.com', 'uploads/1620201300_avatar.png', NULL, 1, '2021-01-20 14:02:37', '2021-06-18 16:47:05'),
(4, 1234565555, '9481554891@ybl', 'John', 'Smith', 'jsmith', '1254737c076cf867dc53d60a0364f38e', 'smith@smith.com',  NULL, NULL, 0, '2021-06-19 08:36:09', '2021-06-19 10:53:12'),
(5, 1236786565, 'aj12we34@paytm', 'Claire', 'Blake', 'cblake', '4744ddea876b11dcb1d169fadf494418', 'blake@blake.com', NULL, NULL, 0, '2021-06-19 10:01:51', '2021-06-19 12:03:23');
...
--
-- Indexes for table `hotelbook_list`
--
ALTER TABLE `hotelbook_list`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `book_list`
--
ALTER TABLE `vehiclebook_list`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `hotelbook_list`
--
ALTER TABLE `hotelbook_list`
  MODIFY `id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `vehiclebook_list`
--
ALTER TABLE `vehiclebook_list`
  MODIFY `id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
