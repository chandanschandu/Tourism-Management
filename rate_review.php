...
<div class="container-fluid">
    <form action="" id="rate-review">
            <input name="hotel_id" type="hidden" value="<?php echo $_GET['id'] ?>" >
        <div class="form-group">
            <label for="" class="control-label">Rate</label>
            <div class="stars">
                    <input value="5" class="star star-5" id="star-5" type="radio" name="rate" /> <label class="star star-5" for="star-5"></label> 
        ...
        <div class="form-group">
            <label for="review" class="control-label">Feedback</label>
            <textarea name="review" id="review" cols="30" rows="10" class="form form-control summernote" style="background-color:red;"></textarea>
        </div>
...
<div class="container-fluid">
    <form action="" id="rate-review">
            <input name="vehicle_id" type="hidden" value="<?php echo $_GET['id'] ?>" >
        <div class="form-group">
            <label for="" class="control-label">Rate</label>
            <div class="stars">
                    <input value="5" class="star star-5" id="star-5" type="radio" name="rate" /> <label class="star star-5" for="star-5"></label> 
