...
if(isset($_GET['id']) && $_GET['id'] > 0){
    $qry = $conn->query("SELECT * from `hotels` where id = '{$_GET['id']}' ");
    if($qry->num_rows > 0){
...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?>Create hotel Package</h3>
	</div>
	<div class="card-body">
		<form action="" id="hotel-form">
            ...
            <div class="form-group">
				<label for="hotel_location" class="control-label">hotel Location</label>
                <textarea name="hotel_location" id="" cols="30" rows="2" class="form-control form no-resize"><?php echo isset($hotel_location) ? $hotel_location : ''; ?></textarea>
			</div>
            <div class="form-group">
            ...
            <div class="form-group">
				<label for="adress" class="control-label">on map</label>
                <textarea name="adress" id="" cols="30" rows="2" class="form-control form no-resize"><?php echo isset($adress) ? $adress : ''; ?></textarea>
			</div>
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="hotel-form">Save</button>
