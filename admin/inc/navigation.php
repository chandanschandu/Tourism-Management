              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=hotels" class="nav-link nav-hotels">
                        <i class="nav-icon fas fa-map-marked"></i>
                        <p>
                          hotels
                        </p>
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=hotelbook" class="nav-link nav-hotelbook">
                        <i class="nav-icon fas fa-th-list"></i>
                        <p>
                          bookedhotels
                        </p>
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=vehiclebook" class="nav-link nav-vehiclebook">
                        <i class="nav-icon fas fa-th-list"></i>
                        <p>
                          bookedvehicle
                        </p>
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=inquiries" class="nav-link nav-enquiries">
