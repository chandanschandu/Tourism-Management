...
<div class="card card-outline card-info">
	...
	<div class="card-body">
		<form action="" id="vehicle-form">
            ...
            <div class="form-group">
				<label for="vehicle_location" class="control-label">Tour Location</label>
                <textarea name="vehicle_location" id="" cols="30" rows="2" class="form-control form no-resize"><?php echo isset($tour_location) ? $tour_location : ''; ?></textarea>
			</div>
            <div class="form-group">
